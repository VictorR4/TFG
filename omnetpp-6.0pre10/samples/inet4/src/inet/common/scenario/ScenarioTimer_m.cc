...
void ScenarioTimerDescriptor::setFieldArraySize(void *object, int field, int size) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
...
void ScenarioTimerDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
...
void ScenarioTimerDescriptor::setFieldStructValuePointer(void *object, int field, int i, void *ptr) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
    ...
    ScenarioTimer *pp = (ScenarioTimer *)object; (void)pp;
    switch (field) {
        case FIELD_xmlNode: pp->setXmlNode((cXMLElement *)ptr); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'ScenarioTimer'", field);
    }
}
