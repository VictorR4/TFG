//
// Generated file, do not edit! Created by nedtool 6.0 from inet/physicallayer/ieee80211/packetlevel/Ieee80211ControlInfo.msg.
//
...
void Ieee80211ConfigureRadioCommandDescriptor::setFieldArraySize(void *object, int field, int size) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
...
void Ieee80211ConfigureRadioCommandDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
...
void Ieee80211ConfigureRadioCommandDescriptor::setFieldStructValuePointer(void *object, int field, int i, void *ptr) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
    ...
    Ieee80211ConfigureRadioCommand *pp = (Ieee80211ConfigureRadioCommand *)object; (void)pp;
    switch (field) {
        case FIELD_band: pp->setBand((IIeee80211Band *)ptr); break;
        case FIELD_channel: pp->setChannel((Ieee80211Channel *)ptr); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Ieee80211ConfigureRadioCommand'", field);
    }
}
