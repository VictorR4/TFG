//
// Generated file, do not edit! Created by nedtool 6.0 from inet/physicallayer/contract/packetlevel/RadioControlInfo.msg.
//
...
void ConfigureRadioCommandDescriptor::setFieldArraySize(void *object, int field, int size) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
...
void ConfigureRadioCommandDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
...
void ConfigureRadioCommandDescriptor::setFieldStructValuePointer(void *object, int field, int i, void *ptr) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
    ...
    ConfigureRadioCommand *pp = (ConfigureRadioCommand *)object; (void)pp;
    switch (field) {
        case FIELD_modulation: pp->setModulation((IModulation *)ptr); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'ConfigureRadioCommand'", field);
    }
}
