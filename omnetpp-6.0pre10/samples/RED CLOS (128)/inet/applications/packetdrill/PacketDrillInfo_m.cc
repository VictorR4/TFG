//
// Generated file, do not edit! Created by nedtool 6.0 from inet/applications/packetdrill/PacketDrillInfo.msg.
//
...
void PacketDrillInfoDescriptor::setFieldArraySize(void *object, int field, int size) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
    ...
    PacketDrillInfo *pp = (PacketDrillInfo *)object; (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'PacketDrillInfo'", field);
    }
}
...
void PacketDrillInfoDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
    ...
    PacketDrillInfo *pp = (PacketDrillInfo *)object; (void)pp;
    switch (field) {
        case FIELD_timeType: pp->setTimeType(string2ulong(value)); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'PacketDrillInfo'", field);
    }
}
...
void PacketDrillInfoDescriptor::setFieldStructValuePointer(void *object, int field, int i, void *ptr) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
